...
using KY.KYV.Topology.Geometries.Implementation;
using System;
using System.Collections.Concurrent;

namespace KY.KYV.Topology
{
    /// <summary>
    /// A geometry service provider class
    /// </summary>
    public class KyvGeometryServices
    {
        private static volatile KyvGeometryServices s_instance = new KyvGeometryServices();
        ...
        public KyvGeometryServices(CoordinateSequenceFactory coordinateSequenceFactory, PrecisionModel precisionModel, int srid)
        {
        ...
        /// <summary>
        /// Gets or sets the default instance of <see cref="KyvGeometryServices"/>.
        /// </summary>
        /// <exception cref="ArgumentNullException">
        /// Thrown when trying to set the value to <see langword="null"/>.
        /// </exception>
        public static KyvGeometryServices Instance
        {
            get => s_instance;
