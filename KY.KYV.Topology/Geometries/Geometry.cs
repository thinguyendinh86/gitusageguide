...
using KY.KYV.Topology.Geometries.Utilities;
using KY.KYV.Topology.IO;
using KY.KYV.Topology.IO.GML2;
using KY.KYV.Topology.Operation;
using KY.KYV.Topology.Operation.Buffer;
using KY.KYV.Topology.Operation.Distance;
using KY.KYV.Topology.Operation.Linemerge;
using KY.KYV.Topology.Operation.Overlay;
using KY.KYV.Topology.Operation.Overlay.Snap;
using KY.KYV.Topology.Operation.Predicate;
using KY.KYV.Topology.Operation.Relate;
using KY.KYV.Topology.Operation.Union;
using KY.KYV.Topology.Operation.Valid;
using System;
    ...
    public abstract class Geometry : IComparable, IComparable<Geometry>
    {
        ...
        public int SRID
        {
            ...
            set
            {
                ...
                _factory = KyvGeometryServices.Instance.CreateGeometryFactory(
