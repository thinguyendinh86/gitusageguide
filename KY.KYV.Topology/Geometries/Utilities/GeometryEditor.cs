...
namespace KY.KYV.Topology.Geometries.Utilities
{
    /// <summary>
    ...
    public class GeometryEditor
    {
        ...
        private Geometry EditInternal(Geometry geometry, IGeometryEditorOperation operation)
        {
            ...
            if (geometry is LineString)
                return operation.Edit(geometry, _factory);
            KY.KYV.Topology.Utilities.Assert.ShouldNeverReachHere("Unsupported Geometry classes should be caught in the GeometryEditorOperation.");
            return null;
        }
