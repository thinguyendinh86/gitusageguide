...
namespace KY.KYV.Topology.Geometries
{
    ...
    /// Mutation should be performed by creating a new Geometry object (see <see cref="T:KY.KYV.Topology.Geometries.Utilities.GeometryEditor"/> 
    /// and <see cref="T:KY.KYV.Topology.Geometries.Utilities.GeometryTransformer"/> for convenient ways to do this).
    ...
    /// <seealso cref="T:KY.KYV.Topology.Geometries.Utilities.GeometryTransformer"/> 
    /// <see cref="T:KY.KYV.Topology.Geometries.Utilities.GeometryEditor"/> 
