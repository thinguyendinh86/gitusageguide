...
namespace KY.KYV.Topology.IO
{
    ...
    public class WKBReader
    {
        ...
        private readonly KyvGeometryServices _geometryServices;
        /**
        ...
        /// <summary>
        /// Initialize reader with a standard <see cref="KyvGeometryServices"/>.
        /// </summary>
        public WKBReader() : this(KyvGeometryServices.Instance) { }

        public WKBReader(KyvGeometryServices services)
        {
            services = services ?? KyvGeometryServices.Instance;
