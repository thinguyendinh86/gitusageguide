...
using KY.KYV.Topology.Utilities;
...
namespace KY.KYV.Topology.IO
{
    ...
    public class WKTReader
    {
        ...
        /// </summary>
        public WKTReader() : this(KyvGeometryServices.Instance.CreateGeometryFactory()) { }
        ...
        {
            get => KyvGeometryServices.Instance.CreateGeometryFactory(_precisionModel, DefaultSRID, _coordinateSequencefactory);
            set
            {
                if (value != null)
                {
        ...
        internal Geometry ReadGeometryTaggedText(TokenStream tokens)
        {
            ...
            var factory = KyvGeometryServices.Instance.CreateGeometryFactory(_precisionModel, srid,
                csFactory);
