...
namespace KY.KYV.Topology.Operation.Linemerge
{
    /// <summary>
    /// A planar graph of edges that is analyzed to sew the edges together. The
    /// <c>marked</c> flag on <see cref="T:KY.KYV.Topology.Planargraph.Edge"/>s
    /// and <see cref="T:KY.KYV.Topology.Planargraph.Node"/>s indicates whether they have been
